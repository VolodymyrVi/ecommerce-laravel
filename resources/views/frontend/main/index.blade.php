            ...
            <div class="banner-slide3 slick" data-slick='{"dots": true, "infinite": true, "speed": 600, "slidesToShow": 1, 
                ...
                <div class="slide">
                    <div class="contant-box position-relative">
                        ...
                        <img class="bg-img hundread-vh" src="{{ asset('frontend/images/home-three/home-3-bg.jpg') }}" alt="image">
                ...
                <div class="slide">
                    <div class="contant-box position-relative">
                        ...
                        <img class="bg-img hundread-vh" src="{{ asset('frontend/images/home-three/home-3-bg-2.jpg') }}" alt="image">
                ...
                <div class="row mt--30">
                    <div class="col-lg-6 h-100 mt-30">
                        <a href="shop-grid.html" class="catagory-single one home3cat">
                            <img src="{{ asset('frontend/images/home-three/cat-1.png') }}" alt="#" class="background-img bg-img imgone">
                            <div class="content">
                        ...
                        <div class="row">
                            <div class="co-12 mt-30 ">
                                <a href="shop-grid.html" class="catagory-single home3cat">
                                    <img src="{{ asset('frontend/images/home-three/catbg-3.png') }}" alt=""
                            ...
                            <div class="col-12 mt-30">
                                <a href="shop-grid.html" class="catagory-single home3cat">
                                    <img src="{{ asset('frontend/images/home-three/catbg-2.png') }}" alt=""
                                        class="background-img bg-img">
                                    <div class="content">
                                        <div class="row w-100 h-100 align-items-center">
                            ...
                            <div class="catagory-slider-three">
                                    ...
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/products-1.jpg') }}" class="first-img"
                                                    alt="" />
                                                <img src="{{ asset('frontend/images/home-three/products-hover-1.png') }}" alt=""
                                                    class="hover-img" />
                                            </a>
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/products-2.jpg') }}" alt="" />
                                            </a>
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/products-3.jpg') }}" class="first-img"
                                                    alt="" />
                                                <img src="{{ asset('frontend/images/home-three/products-hover-3.png') }}" alt=""
                                                    class="hover-img" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/products-4.jpg') }}" alt="" />
                                            </a>
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img img-bg">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/products-5.png') }}" alt="" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/products-6.png') }}" alt="" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                class="addcart btn--primary style2"> Add To Cart </a>
                            ...
                            <div class="catagory-slider-three">
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss2-1.jpg') }}" class="first-img"
                                                    alt="" />
                                                <img src="{{ asset('frontend/images/home-three/productss2-hover-1.png') }}" alt=""
                                                    class="hover-img" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> <span
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss2-2.jpg') }}" alt="" />
                                            </a>
                                            <a href="cart.html" class="addcart btn--primary style2">
                                                Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss2-3.jpg') }}" class="first-img"
                                                    alt="" />
                                                <img src="{{ asset('frontend/images/home-three/productss2-hover-3.png') }}" alt=""
                                                    class="hover-img" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss2-4.jpg') }}" alt="" />
                                            </a>
                                            <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                                <ul>
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img img-bg">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss2-5.jpg') }}" alt="" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_black badge discount">-10%</span> </div> <a
                                                href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                            ...
                            <div class="catagory-slider-three">
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss3-1.jpg') }}" class="first-img"
                                                    alt="" />
                                                <img src="{{ asset('frontend/images/home-three/productss3-hover-1.jpg') }}" alt=""
                                                    class="hover-img" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> <span
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss3-2.jpg') }}" alt="" />
                                            </a>
                                            <a href="cart.html" class="addcart btn--primary style2">
                                                Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss3-3.jpg') }}" class="first-img"
                                                    alt="" />
                                                <img src="{{ asset('frontend/images/home-three/productss3-hover-3.png') }}" alt=""
                                                    class="hover-img" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss3-4.jpg') }}" alt="" />
                                            </a>
                                            <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                                <ul>
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img img-bg">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss3-5.png') }}" alt="" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_black badge discount">-10%</span> </div> <a
                                                href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                ...
                                <div class="products-three__inner">
                                    <div class="products-three-single w-100">
                                        <div class="products-three-single-img">
                                            <a href="shop-details-3.html" class="d-block">
                                                <img src="{{ asset('frontend/images/home-three/productss3-3.jpg') }}" alt="" />
                                            </a>
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                                class="addcart btn--primary style2"> Add To Cart </a>
                        ...
                        <div class="products-three__inner">
                            <ul>
                                ...
                                <li class="products-three-single wow fadeInUp animated">
                                    <div class="products-three-single-img">
                                        <a href="shop-details-3.html" class="d-block"> <img
                                                src="{{ asset('frontend/images/home-three/productss2-1.jpg') }}" class="first-img"
                                                alt="" /> <img src="{{ asset('frontend/images/home-three/productss2-hover-1.png') }}"
                                                            ...
                                                            <div class="popup-product-thumb-box">
                                                                <ul>
                                                                    <li class="tab-nav popup-product-thumb"> <a
                                                                            href="#tabb1"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img5.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tabb2"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img6.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tabb3"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img7.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                </ul>
                                                            </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="popup-right-content">
                                                        ...
                                                        <div class="payment-method"> <a href="#0"> <img
                                                                    src="{{ asset('frontend/images/payment_method/method_1.png') }}"
                                                                    alt=""> </a> <a href="#0"> <img
                                                                    src="{{ asset('frontend/images/payment_method/method_2.png') }}"
                                                                    alt=""> </a> <a href="#0"> <img
                                                                    src="{{ asset('frontend/images/payment_method/method_3.png') }}"
                                                                    alt=""> </a> <a href="#0"> <img
                                                                    src="{{ asset('frontend/images/payment_method/method_4.png') }}"
                                                                    alt=""> </a> </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li class="products-three-single wow fadeInUp animated">
                                    <div class="products-three-single-img">
                                        <a href="shop-details-3.html" class="d-block">
                                            <img src="{{ asset('frontend/images/home-three/productss2-hover-2.png') }}" class="first-img"
                                                alt="" />
                                            <img src="{{ asset('frontend/images/home-three/productss2-2.jpg') }}" alt=""
                                                class="hover-img" />
                                        </a>
                                                        ...
                                                        <div class="tabs">
                                                            <div class="popup-product-thumb-box">
                                                                <ul>
                                                                    ...
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tabb33"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img8.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                </ul>
                                                            </div>
                                                            <div class="popup-product-main-image-box">
                                ...
                                <li class="products-three-single wow fadeInUp animated">
                                    <div class="products-three-single-img">
                                        <a href="shop-details-3.html" class="d-block">
                                            <img src="{{ asset('frontend/images/home-three/productss2-3.jpg') }}" alt="" />
                                        </a>
                                                            ...
                                                            <div class="tabs">
                                                                <div class="popup-product-thumb-box">
                                                                    <ul>
                                                                        ...
                                                                        <li class="tab-nav popup-product-thumb "> <a
                                                                                href="#tabb333"> <img
                                                                                    src="{{ asset('frontend/images/shop/products-v6-img9.jpg') }}"
                                                                                    alt="" /> </a> </li>
                                                                    </ul>
                                                                </div>
                                                                <div class="popup-product-main-image-box">
                                ...
                                <li class="products-three-single  wow fadeInUp animated">
                                    <div class="products-three-single-img"> <a href="shop-details-3.html"
                                            class="d-block"> <img src="{{ asset('frontend/images/home-three/productss2-4.jpg') }}"
                                                alt="" />
                                        </a>
                                        <div class="products-grid-one__badge-box"> <span
                                                        ...
                                                        <div class="tabs">
                                                            <div class="popup-product-thumb-box">
                                                                <ul>
                                                                    ...
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tabb3333"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img10.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                </ul>
                                                            </div>
                                                            <div class="popup-product-main-image-box">
                                ...
                                <li class="products-three-single   wow fadeInUp animated">
                                    <div class="products-three-single-img">
                                        <a href="shop-details-3.html" class="d-block">
                                            <img src="{{ asset('frontend/images/home-three/productss2-5.jpg') }}" class="first-img"
                                                alt="" />
                                            <img src="{{ asset('frontend/images/home-three/productss2-hover-5.png') }}" alt=""
                                                class="hover-img" />
                                        </a>
                                        <a href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                        <div class="products-grid__usefull-links">
                                                        ...
                                                        <div class="tabs">
                                                            <div class="popup-product-thumb-box">
                                                                <ul>
                                                                    <li class="tab-nav popup-product-thumb"> <a
                                                                            href="#tab1"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img1.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tab2"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img2.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tab3"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img3.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                </ul>
                                                            </div>
                                                            <div class="popup-product-main-image-box">
                                ...
                                <li class="products-three-single wow fadeInUp animated">
                                    <div class="products-three-single-img"> <a href="shop-details-3.html"
                                            class="d-block"> <img src="{{ asset('frontend/images/home-three/productss3-2.jpg') }}"
                                                alt="" />
                                ...
                                <li class="products-three-single wow fadeInUp animated">
                                    <div class="products-three-single-img">
                                        <a href="shop-details-3.html" class="d-block">
                                            <img src="{{ asset('frontend/images/home-three/productss3-3.jpg') }}" alt="" /> </a>
                                        <div class="products-grid-one__badge-box"> <span
                                                class="bg_base badge new ">New</span> </div> <a href="cart.html"
                                            class="addcart btn--primary style2"> Add To Cart </a>
                                        <div class="products-grid__usefull-links">
                                                        ...
                                                        <div class="tabs">
                                                            <div class="popup-product-thumb-box">
                                                                <ul>
                                                                    ...
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tab222"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img4.jpg') }}"
                                                                                alt="" /> </a> </li>
                                                                    <li class="tab-nav popup-product-thumb "> <a
                                                                            href="#tab333"> <img
                                                                                src="{{ asset('frontend/images/shop/products-v6-img5.jpg') }}"
                                ...
                                <li class="products-three-single wow fadeInUp animated">
                                    <div class="products-three-single-img"> <a href="shop-details-3.html"
                                            class="d-block"> <img src="{{ asset('frontend/images/home-three/productss3-4.jpg') }}"
                                                alt="" />
                                        </a> <a href="cart.html" class="addcart btn--primary style2">
                                            Add To Cart </a>
                                        <div class="products-grid__usefull-links">
                                ...
                                <li class="products-three-single wow fadeInUp animated">
                                    <div class="products-three-single-img img-bg">
                                        <a href="shop-details-3.html" class="d-block">
                                            <img src="{{ asset('frontend/images/home-three/productss2-1.jpg') }}" alt="" />
                                            <div class="products-grid-one__badge-box"> <span
                                                    class="bg_black badge discount">-10%</span> </div> <a
                                                href="cart.html" class="addcart btn--primary style2"> Add To Cart </a>
                                            <div class="products-grid__usefull-links">
                                                                    ...
                                                                    <div class="popup-product-main-image-box">
                                                                        <div id="tab11111"
                                                                            ...
                                                                            <div class="popup-product-single-image">
                                                                                <img src="{{ asset('frontend/images/shop/products-v6-img5.jpg') }}"
                                                                                    alt="" /> </div>
                                                                        </div>
                                                                        <div id="tab22222"
                                                                            class="tab-item popup-product-image">
                                                                            <div class="popup-product-single-image">
                                                                                <img src="{{ asset('frontend/images/shop/products-v6-img6.jpg') }}"
                                                                                    alt="" /> </div>
                                                                        </div>
                                                                        <div id="tab33333"
                                                                            class="tab-item popup-product-image">
                                                                            <div class="popup-product-single-image">
                                                                                <img src="{{ asset('frontend/images/shop/products-v6-img7.jpg') }}"
                                                                                    alt="" /> </div>
                                                                        </div> <button class="prev"> <i
                        ...
                        <div class="product-slider-main position-relative ">
                            <div class="product-slider__single text-center">
                                <div
                                    ...
                                    <div class="img-box">
                                        <img src="{{ asset('frontend/images/home-three/fimg.png') }}" alt="" />
                                    </div>
